          ...
          <div className="col-lg-10">
            <div className="row">
              ...
              <div className="col-md-6 mb-5">
                <h3 className="h4 fw-bold text-primary mb-4">Technical Skills</h3>
                <p className="text-secondary" style={{ fontSize: '17px', lineHeight: '1.8' }}>
                  {hardSkills.map((skill, index) => (
                    <span key={`hard-skill-${index}`}>
                      {skill.name}
                      {index < hardSkills.length - 1 && <span className="text-secondary opacity-50"> • </span>}
                    </span>
                  ))}
                </p>
              </div>
                ...
                <p className="text-secondary" style={{ fontSize: '17px', lineHeight: '1.8' }}>
                  {softSkills.map((skill, index) => (
                    <span key={`soft-skill-${index}`}>
                      {skill.name}
                      {index < softSkills.length - 1 && <span className="text-secondary opacity-50"> • </span>}
                    </span>
                  ))}
                </p>
              </div>
